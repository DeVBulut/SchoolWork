...
public class Chapter5Problem44Strings {
	...
	public static void main(String[] args) {
		solveTheEquation();
		System.out.println(makeLongString1(50));
		System.out.println(makeLongString2(50));
	...
	public static String makeLongString1( int N )
	{
		...
		for( int i = 0; i < N; i++ )
			result += "x";
		System.out.println("Run time is O(N^2), time it takes to make this action is " + (System.nanoTime() - time));
		return result;
	}
	...
	public static String makeLongString2( int N )
	{
		...
		for( int i = 0; i < N; i++ )
			result.append( "x" );
		System.out.println("Run time is O(N), time it takes to make this action is " + (System.nanoTime() - time));
